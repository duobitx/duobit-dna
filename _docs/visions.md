...
One big aha in our evolution was when we [realized](http://blog.crisp.se/2010/05/08/henrikkniberg/1273272420000) that {{ site.company_name }} itself is just a platform. {{ site.company_name }} doesn't have a Vision (with a Big V), we just want {{ site.company_name }} to be a [nice home for consultants](what-is-crisp.html).

However, many of the *people* at {{ site.company_name }} do have a vision. Here are the most widely shared visions:
...
-   {{ site.company_name }} can have several visions.
...
-   We bring this poster to our conferences, so we keep iterating on it (just like our two A3s [What is {{ site.company_name }}](what-is-crisp.html) and [How we work](how-crisp-works.html)).
