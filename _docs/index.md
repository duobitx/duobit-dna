...
Why open-source the {{ site.company_name }} DNA?
------------------------------------------------
...
-   [Board of directors](board.html) - Swedish law requires that we have a BoD. So how does the BoD at {{ site.company_name }} work?
